...
I misunderstood something about the first part so I created a function that could take store the order of the operations. It was useless for part 1 but was very helpfull for part 2. So part 1 expects a 2d array with the data and an int to say in which order it is executed.

## ---- NOTES on part 2

You could probably find the loop and skip checking it in every loop. Im not sure how right now but I might check this day again to improve it if possible
